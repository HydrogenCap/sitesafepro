...
const tiers: Array<{
...
}> = [
  {
    ...
    features: [
      ...
      "Digital e-signatures & acknowledgements",
      "Site induction register",
      "QR code site access & sign-in",
      "Real-time headcount dashboard",
      "Emergency muster list export",
  ...
  },
  {
    ...
    features: [
      ...
      "RAMS Builder (80+ activities)",
      "Permits to work (6 types)",
      "35 pre-loaded toolbox talks",
      "Site inspections (8 categories)",
      "Incident reporting & investigation",
      "RIDDOR guidance & flagging",
      "COSHH substance register",
